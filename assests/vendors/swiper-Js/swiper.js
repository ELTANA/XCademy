                ...
                for (var a = Object(e[0]), i = 1; i < e.length; i += 1) {
                    ...
                    if (null != s)
                        for (var r = Object.keys(Object(s)), n = 0, o = r.length; n < o; n += 1) {
                            ...
                            void 0 !== d &&
                                d.enumerable &&
                                (X.isObject(a[l]) && X.isObject(s[l]) ? X.extend(a[l], s[l]) : !X.isObject(a[l]) && X.isObject(s[l]) ? ((a[l] = {}), X.extend(a[l], s[l])) : (a[l] = s[l]));
                        }
                }
                return a;
            },
    ...
    var o = {
        ...
        updateSlides: function () {
            ...
            if (void 0 !== i) {
                    ...
                    if (1 < t.slidesPerColumn) {
                        ...
                        "column" === t.slidesPerColumnFill
                            ? ((L = z - ($ = Math.floor(z / S)) * S),
                              ...
                              (P = $ + (L * x) / S),
                              k.css({ "-webkit-box-ordinal-group": P, "-moz-box-ordinal-group": P, "-ms-flex-order": P, "-webkit-order": P, order: P }))
                    ...
                    if ("none" !== k.css("display")) {
                        if ("auto" === t.slidesPerView) {
                            ...
                            D && (k[0].style.transform = "none"),
                                ...
                                (E = e.isHorizontal()
                                    ? k[0].getBoundingClientRect().width + parseFloat(I.getPropertyValue("margin-left")) + parseFloat(I.getPropertyValue("margin-right"))
                                    : k[0].getBoundingClientRect().height + parseFloat(I.getPropertyValue("margin-top")) + parseFloat(I.getPropertyValue("margin-bottom"))),
                        ...
                        l[z] && (l[z].swiperSlideSize = E),
                            ...
                            t.centeredSlides
                                ? ((b = b + E / 2 + w / 2 + g),
                                  ...
                                  c.push(b))
                                : (t.roundLengths && (b = Math.floor(b)), y % t.slidesPerGroup == 0 && p.push(b), c.push(b), (b = b + E + g)),
                            (e.virtualSize += E + g),
                            (w = E),
                            (y += 1);
                    }
                ...
                if (
                    ...
                    (Y.flexbox && !t.setWrapperSize) || (e.isHorizontal() ? a.css({ width: e.virtualSize + t.spaceBetween + "px" }) : a.css({ height: e.virtualSize + t.spaceBetween + "px" })),
                    1 < t.slidesPerColumn &&
                ...
                0 === p.length && (p = [0]),
                    ...
                    X.extend(e, { slides: l, snapGrid: p, slidesGrid: c, slidesSizesGrid: u }),
        ...
        updateActiveIndex: function (e) {
            ...
            if (((t = 0 <= r.indexOf(i) ? r.indexOf(i) : Math.floor(p / n.slidesPerGroup)) >= r.length && (t = r.length - 1), p !== o)) {
                ...
                X.extend(a, { snapIndex: t, realIndex: u, previousIndex: o, activeIndex: p }),
                    ...
                    if ((r.originalEvent && (r = r.originalEvent), (a.isTouchEvent = "touchstart" === r.type), (a.isTouchEvent || !("which" in r) || 3 !== r.which) && (!a.isTouched || !a.isMoved)))
                        if (i.noSwiping && L(r.target).closest(i.noSwipingSelector ? i.noSwipingSelector : "." + i.noSwipingClass)[0]) t.allowClick = !0;
                            ...
                            if (!l || !(n <= d || n >= B.screen.width - d)) {
                                if (
                                    (X.extend(a, { isTouched: !0, isMoved: !1, allowTouchCallbacks: !0, isScrolling: void 0, startMoving: void 0 }),
                                    (s.startX = n),
                                    (s.startY = o),
                                    ...
                                    if (
                                        ...
                                        i.followFinger &&
                                            ...
                                            i.freeMode &&
                                                ...
                                                a.velocities.push({ position: s[t.isHorizontal() ? "currentX" : "currentY"], time: X.now() })),
                    ...
                    if (((a.isTouched = !1), (a.isMoved = !1), (a.startMoving = !1), (p = i.followFinger ? (r ? t.translate : -t.translate) : -a.currentTranslate), i.freeMode)) {
                        ...
                        if (i.freeModeMomentum) {
                            ...
                            if (w < t.maxTranslate())
                                i.freeModeMomentumBounce
                                    ? (w + t.maxTranslate() < -T && (w = t.maxTranslate() - T), (y = t.maxTranslate()), (E = !0), (a.allowMomentumBounce = !0))
                                    : (w = t.maxTranslate()),
                                    i.loop && i.centeredSlides && (x = !0);
                            else if (w > t.minTranslate())
                                i.freeModeMomentumBounce
                                    ? (w - t.minTranslate() > T && (w = t.minTranslate() + T), (y = t.minTranslate()), (E = !0), (a.allowMomentumBounce = !0))
                                    : (w = t.minTranslate()),
                                    i.loop && i.centeredSlides && (x = !0);
                        ...
                        for (var M = 0, z = t.slidesSizesGrid[0], k = 0; k < o.length; k += i.slidesPerGroup)
                            void 0 !== o[k + i.slidesPerGroup]
                                ? p >= o[k] && p < o[k + i.slidesPerGroup] && (z = o[(M = k) + i.slidesPerGroup] - o[k])
                                : p >= o[k] && ((M = k), (z = o[o.length - 1] - o[o.length - 2]));
                        var P = (p - o[M]) / z;
                        if (u > i.longSwipesMs) {
            ...
            if (Y.touch || (!Y.pointerEvents && !Y.prefixedPointerEvents)) {
                if (Y.touch) {
                    ...
                    r.addEventListener(a.start, e.onTouchStart, o),
                        r.addEventListener(a.move, e.onTouchMove, Y.passiveListener ? { passive: !1, capture: n } : n),
                        r.addEventListener(a.end, e.onTouchEnd, o);
                }
                ((t.simulateTouch && !m.ios && !m.android) || (t.simulateTouch && !Y.touch && m.ios)) &&
            ...
            setBreakpoint: function () {
                ...
                if (r && (!r || 0 !== Object.keys(r).length)) {
                    ...
                    if (n && e.currentBreakpoint !== n) {
                        ...
                        X.extend(e.params, o),
                            X.extend(e, { allowTouchMove: e.params.allowTouchMove, allowSlideNext: e.params.allowSlideNext, allowSlidePrev: e.params.allowSlidePrev }),
    ...
    var x = {
                ...
                (h.prototype.destroy = function (e, t) {
                    ...
                    return (
                        void 0 === a.params ||
                            ...
                            !1 !== e && ((a.$el[0].swiper = null), a.$el.data("swiper", null), X.deleteProps(a)),
                            (a.destroyed = !0)),
                        null
                    );
                }),
        ...
        P = {
            ...
            attach: function (e, t) {
                ...
                i.observe(e, { attributes: void 0 === t.attributes || t.attributes, childList: void 0 === t.childList || t.childList, characterData: void 0 === t.characterData || t.characterData }),
        ...
        D = {
            update: function (e) {
                ...
                if ((X.extend(t.virtual, { from: g, to: b, offset: w, slidesGrid: t.slidesGrid }), o === g && l === b && !e))
                    return t.slidesGrid !== p && w !== u && t.slides.css(h, w + "px"), void t.updateProgress();
    ...
    var G = {
            ...
            setTranslate: function () {
                ...
                if (e.params.scrollbar.el && e.scrollbar.el) {
                    ...
                    a ? (0 < (p = -p) ? ((d = s - p), (p = 0)) : r < -p + s && (d = r + p)) : p < 0 ? ((d = s + p), (p = 0)) : r < p + s && (d = r - p),
                        e.isHorizontal()
                            ? (Y.transforms3d ? n.transform("translate3d(" + p + "px, 0, 0)") : n.transform("translateX(" + p + "px)"), (n[0].style.width = d + "px"))
                            : (Y.transforms3d ? n.transform("translate3d(0px, " + p + "px, 0)") : n.transform("translateY(" + p + "px)"), (n[0].style.height = d + "px")),
                        l.hide &&
            ...
            updateSize: function () {
                ...
                if (e.params.scrollbar.el && e.scrollbar.el) {
                    ...
                    (s = "auto" === e.params.scrollbar.dragSize ? r * n : parseInt(e.params.scrollbar.dragSize, 10)),
                        ...
                        X.extend(t, { trackSize: r, divider: n, moveDivider: o, dragSize: s }),
                ...
                if (e.params.scrollbar.el) {
                    ...
                    Y.touch || (!Y.pointerEvents && !Y.prefixedPointerEvents)
                        ? (Y.touch &&
                          ...
                          ((s.simulateTouch && !m.ios && !m.android) || (s.simulateTouch && !Y.touch && m.ios)) &&
        ...
        W = {
            ...
            onGestureChange: function (e) {
                ...
                i.$imageEl &&
                    0 !== i.$imageEl.length &&
                    (Y.gestures ? (this.zoom.scale = e.scale * a.currentScale) : (a.scale = (i.scaleMove / i.scaleStart) * a.currentScale),
                ...
                if (e.params.history) {
                    ...
                    (t.initialized = !0),
                        ...
                        (t.paths.key || t.paths.value) &&
                            (t.scrollToSlide(0, t.paths.value, e.params.runCallbacksOnInit), e.params.history.replaceState || B.addEventListener("popstate", e.history.setHistoryPopState));
                }
            },
            destroy: function () {
        ...
        ae = [
            ...
            },
            {
                ...
                create: function () {
                    var t = this;
                    X.extend(t, { a11y: { liveRegion: L('<span class="' + t.params.a11y.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>') } }),
